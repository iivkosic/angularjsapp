(function ()
{
    ...
    /** @ngInject */
    function ToolbarController($rootScope, $mdSidenav, $translate, $mdToast, msNavigationService, $timeout,Auth)
    {

          var vm = this;

          vm.userName = Auth.authz.idTokenParsed.name;
        ...
        function getActiveNavigationItem() {
            $timeout(function() {
                vm.activeNavItem = msNavigationService.getActiveItem().node;
            }, 10);
        }
    }
