(function ()
{
    ...
    /** @ngInject */
    function NotesController($document, $timeout, $scope, $mdSidenav, NotesService, LabelsService, NotesLabelsService, $mdDialog)
    {
        var vm = this;
        ...
        vm.notes_labels = NotesLabelsService.data;
        vm.search = '';
